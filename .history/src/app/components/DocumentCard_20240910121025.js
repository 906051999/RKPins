...
const DocumentCard = ({ document, onClick, highlightedText }) => {
  ...
  return (
    <div 
      className="bg-white bg-opacity-80 rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300 cursor-pointer flex flex-col"
