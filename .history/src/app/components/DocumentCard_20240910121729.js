  ...
  return (
    ...
    >
      <div className="p-4 sm:p-6 flex flex-col flex-grow overflow-hidden">
        ...
        <div className="text-sm sm:text-base text-gray-600 prose prose-sm sm:prose-base max-w-none overflow-y-auto flex-grow">
      ...
      {document.tags && document.tags.length > 0 && (
        <div className="p-4 sm:p-6 bg-gray-50 overflow-y-auto max-h-[120px]">
